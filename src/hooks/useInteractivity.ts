...
const useInteractivity = () => {
  ...
  const colors = ["#f4f4f4", "#e8f5e8", "#fff2e8", "#f0e8ff", "#e8f4fd"]; //erstellt colors array
  ...
  }, [backgroundColor, colors]); //dependecies für useCallback Funktion, also Werte die schon im Component Body (useInteractivity) deklariert wurden
