...
test.describe('Visual Regression Tests', () => {
  ...
  test('should match home page with different background colors', async ({ page }) => {
    await page.goto('/');
    await page.waitForLoadState('networkidle');
  ...
  test('should match counter states', async ({ page }) => {
    ...
    await expect(page.locator('#interactive')).toHaveScreenshot('counter-state-0.png', {
      animations: 'disabled'
    });
    ...
    await expect(page.locator('#interactive')).toHaveScreenshot('counter-state-6-orange.png', {
      animations: 'disabled'
    });
    ...
    await expect(page.locator('#interactive')).toHaveScreenshot('counter-state-12-red.png', {
      animations: 'disabled'
    });
  });
  ...
  test('should match message display states', async ({ page }) => {
    ...
    await expect(userInputSection).toHaveScreenshot('message-success-state.png', {
      animations: 'disabled'
    });
  });
