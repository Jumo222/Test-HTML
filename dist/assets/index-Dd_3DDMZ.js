...
function _s(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      Cs.call(t, r) && !Es.hasOwnProperty(r) && (l[r] = t[r]);
...
var x = ys.exports;
const Ns = Qc(x),
  sf = Hc({ __proto__: null, default: Ns }, [x]);
/**
 * @license React
 ...
 */ (function (e) {
  ...
  function r(P) {
    ...
    if (R !== L) {
      P[0] = R;
      e: for (var Q = 0, Z = P.length, ar = Z >>> 1; Q < ar; ) {
        var wt = 2 * (Q + 1) - 1,
          Rl = P[wt],
          St = wt + 1,
          cr = P[St];
        if (0 > l(Rl, R))
          St < Z && 0 > l(cr, Rl)
            ? ((P[Q] = cr), (P[St] = R), (Q = St))
            : ((P[Q] = Rl), (P[wt] = R), (Q = wt));
        else if (St < Z && 0 > l(cr, R)) (P[Q] = cr), (P[St] = R), (Q = St);
        else break e;
      }
    }
    return L;
  ...
  function g(P) {
    if (((S = !1), d(P), !w))
      if (n(s) !== null) (w = !0), Tl(C);
      else {
        var L = n(a);
        L !== null && Ll(g, L.startTime - P);
      }
  }
  function C(P, L) {
    ...
    try {
      for (
        d(L), p = n(s);
        p !== null && (!(p.expirationTime > L) || (P && !je()));
      ...
      if (p !== null) var ar = !0;
        ...
        var wt = n(a);
        wt !== null && Ll(g, wt.startTime - L), (ar = !1);
      }
      return ar;
    } finally {
      (p = null), (m = R), (y = !1);
      ...
      return (
        ...
        R > Q
          ? ((P.sortIndex = R),
            ...
            n(s) === null &&
              P === n(a) &&
              (S ? (f(T), (T = -1)) : (S = !0), Ll(g, R - Q)))
          : ((P.sortIndex = Z), t(s, P), w || y || ((w = !0), Tl(C))),
        P
      );
    }),
...
function nn(e, t) {
  for (Dn[e] = t, e = 0; e < t.length; e++) zs.add(t[e]);
}
var Ke = !(
    typeof window > "u" ||
...
function cu(e) {
  if ((e = ir(e))) {
    ...
    var t = e.stateNode;
    t && ((t = gl(t)), Si(e.stateNode, e.type, t));
  }
}
function Hs(e) {
...
function Qs() {
  if (Zt) {
    var e = Zt,
      t = qt;
    if (((qt = Zt = null), cu(e), t)) for (e = 0; e < t.length; e++) cu(t[e]);
  }
}
function Ks(e, t) {
  return e(t);
...
function jf(e, t, n, r, l, i, o, u, s) {
  (Tn = !1), (Wr = null), Pf.apply(Nf, arguments);
}
...
function Js(e) {
  return (e = Lf(e)), e !== null ? Zs(e) : null;
}
function Zs(e) {
...
function Vf(e, t, n, r, l) {
  switch (t) {
    ...
    case "gotpointercapture":
      return (
        (i = l.pointerId), An.set(i, yn(An.get(i) || null, e, t, n, r, l)), !0
      );
  }
  return !1;
}
...
function go(e, t, n, r) {
  if (Kr) {
    var l = _i(e, t, n, r);
    if (l === null) Yl(e, t, r, Yr, n), pu(e, r);
...
var Yr = null;
function _i(e, t, n, r) {
  if (((Yr = null), (e = po(r)), (e = Ct(e)), e !== null))
...
var fn = {
  ...
  vu = ke(hl),
  Xf = W({}, hl, { dataTransfer: 0 }),
  Gf = ke(Xf),
  Jf = W({}, lr, { relatedTarget: 0 }),
  Bl = ke(Jf),
  Zf = W({}, fn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  qf = ke(Zf),
  bf = W({}, fn, {
...
var od = W({}, lr, {
  ...
  cd = ke(ad),
  fd = W({}, fn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  dd = ke(fd),
  pd = W({}, hl, {
    deltaX: function (e) {
  ...
  hd = ke(pd),
  md = [9, 13, 27, 32],
  ko = Ke && "CompositionEvent" in window,
  Ln = null;
Ke && "documentMode" in document && (Ln = document.documentMode);
var vd = Ke && "TextEvent" in window && !Ln,
  ca = Ke && (!ko || (Ln && 8 < Ln && 11 >= Ln)),
  wu = " ",
  Su = !1;
function fa(e, t) {
  switch (e) {
...
function yd(e, t) {
  if (Bt)
    return e === "compositionend" || (!ko && fa(e, t))
      ? ((e = aa()), (Rr = yo = nt = null), (Bt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
if (Ke) {
  ...
  ha = Al && (!document.documentMode || 9 < document.documentMode);
}
function Cu() {
  Rn && (Rn.detachEvent("onpropertychange", ma), (Vn = Rn = null));
}
function ma(e) {
  if (e.propertyName === "value" && ml(Vn)) {
    var t = [];
    pa(t, Vn, e, po(e)), Xs(Sd, t);
  }
}
function xd(e, t, n) {
  e === "focusin"
    ? (Cu(), (Rn = t), (Vn = n), Rn.attachEvent("onpropertychange", ma))
    : e === "focusout" && Cu();
}
function Cd(e) {
...
var Ie = typeof Object.is == "function" ? Object.is : Pd;
function Hn(e, t) {
  if (Ie(e, t)) return !0;
...
var wa = vl("animationend"),
  Sa = vl("animationiteration"),
  ka = vl("animationstart"),
  xa = vl("transitionend"),
  Ca = new Map(),
  Nu =
...
function Ea(e, t) {
  ...
  if (Vr) throw ((e = xi), (Vr = !1), (xi = null), e);
}
function D(e, t) {
  var n = t[zi];
  ...
  if (!e[Sr]) {
    (e[Sr] = !0),
      zs.forEach(function (n) {
        n !== "selectionchange" && (Rd.has(n) || Kl(n, !1, e), Kl(n, !0, e));
      });
...
function Yl(e, t, n, r, l) {
  ...
  Xs(function () {
        ...
        for (var c = a, d; c !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              g !== null &&
              ((d = g),
              f !== null && ((g = $n(c, f)), g != null && S.push(Kn(c, g, d)))),
            E)
          )
            break;
          c = c.return;
    ...
    if (!(t & 7)) {
      ...
      switch (((N = a ? Vt(a) : window), e)) {
        case "focusin":
          (ku(N) || N.contentEditable === "true") &&
            ((At = N), (Pi = a), (zn = null));
          break;
        case "focusout":
          zn = Pi = At = null;
      ...
      T &&
        (ca &&
          ...
          (Bt || T !== "onCompositionStart"
            ? T === "onCompositionEnd" && Bt && (j = aa())
            : ((nt = h),
              (yo = "value" in nt ? nt.value : nt.textContent),
              (Bt = !0))),
        (N = Xr(a, T)),
        0 < N.length &&
          ((T = new gu(T, e, null, n, h)),
          p.push({ event: T, listeners: N }),
          j ? (T.data = j) : ((j = da(n)), j !== null && (T.data = j)))),
        (j = vd ? gd(e, n) : yd(e, n)) &&
...
var Ri = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Id =
    typeof queueMicrotask == "function"
      ...
      : typeof Ru < "u"
      ? function (e) {
          return Ru.resolve(null).then(e).catch(Fd);
        }
      : Ri;
function Fd(e) {
  setTimeout(function () {
...
function yt() {
  if (!Gl && We !== null) {
    ...
    try {
      ...
      throw (We !== null && (We = We.slice(e + 1)), qs(ho, yt), l);
    } finally {
      (I = t), (Gl = !1);
    }
  }
...
function ja(e, t, n) {
  (xe[Ce++] = Ve), (xe[Ce++] = He), (xe[Ce++] = Tt), (Tt = e);
  var r = Ve;
  e = He;
  var l = 32 - Oe(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function Ra(e) {
  ...
  function s(f, c, d, g) {
    ...
    return C === $t
      ...
      : ((g = $r(d.type, d.key, d.props, null, f.mode, g)),
        (g.ref = kn(f, c, d)),
        (g.return = f),
        g);
  }
  ...
  function h(f, c, d, g, C) {
    return c === null || c.tag !== 7
      ? ((c = Nt(d, f.mode, g, C)), (c.return = f), c)
      : ((c = l(c, d)), (c.return = f), c);
  }
  function p(f, c, d) {
  ...
  function m(f, c, d, g) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (_n(d) || vn(d)) return C !== null ? null : h(f, c, d, g, null);
      Cr(f, d);
    }
    return null;
  }
  function y(f, c, d, g, C) {
    ...
    if (typeof g == "object" && g !== null) {
      switch (g.$$typeof) {
        ...
        case qe:
          var N = g._init;
          return y(f, c, d, N(g._payload), C);
      }
      if (_n(g) || vn(g)) return (f = f.get(d) || null), h(c, f, g, C, null);
      Cr(c, g);
    }
    return null;
  }
  function w(f, c, d, g) {
    for (
      var C = null, N = null, j = c, T = (c = 0), H = null;
      j !== null && T < d.length;
      T++
    ) {
    ...
    if (T === d.length) return n(f, j), $ && kt(f, T), C;
    if (j === null) {
      for (; T < d.length; T++)
        (j = p(f, d[T], g)),
          j !== null &&
            ((c = i(j, c, T)), N === null ? (C = j) : (N.sibling = j), (N = j));
      return $ && kt(f, T), C;
    }
  ...
  function S(f, c, d, g) {
    ...
    for (
      var N = (C = null), j = c, T = (c = 0), H = null, O = d.next();
      j !== null && !O.done;
      T++, O = d.next()
    ) {
      j.index > T ? ((H = j), (j = null)) : (H = j.sibling);
    ...
    if (O.done) return n(f, j), $ && kt(f, T), C;
    if (j === null) {
      for (; !O.done; T++, O = d.next())
        (O = p(f, O.value, g)),
          O !== null &&
            ((c = i(O, c, T)), N === null ? (C = O) : (N.sibling = O), (N = O));
      return $ && kt(f, T), C;
    }
      ...
      switch (d.$$typeof) {
        ...
        case Ut:
          e: {
            ...
            (c = ri(d, f.mode, g)), (c.return = f), (f = c);
          }
          return o(f);
        case qe:
          return (N = d._init), E(f, c, N(d._payload), g);
      }
...
function Io(e, t, n, r, l, i) {
  if (
    ...
    i = 0;
    do {
      if (((On = !1), (Jn = 0), 25 <= i)) throw Error(k(301));
      (i += 1),
        (q = G = null),
        (t.updateQueue = null),
        (Mr.current = Yd),
...
function Da(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Do(Ba.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || i || (q !== null && q.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      qn(9, $a.bind(null, n, r, l, t), void 0, null),
      b === null)
    )
      throw Error(k(349));
    Lt & 30 || Ua(n, t, l);
...
function $a(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), Aa(t) && Wa(e);
}
function Ba(e, t, n) {
  return n(function () {
    Aa(t) && Wa(e);
...
function Ya(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), wl(4, 4, Ka.bind(null, t, e), n)
  );
}
function Uo() {}
function Xa(e, t) {
...
function Ja(e, t, n) {
  return Lt & 21
    ? (Ie(n, t) || ((n = ta()), (A.lanes |= n), (Rt |= n), (e.baseState = !0)),
      t)
...
function Hd(e, t, n) {
  ...
  if (qa(e)) ba(t, l);
    ...
    (n = Oa(e, t, l, r)),
      n !== null && ((l = se()), Me(n, e, r, l), ec(n, t, r));
  }
}
function qa(e) {
  var t = e.alternate;
  ...
  Qd = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Ir(4194308, 4, Ka.bind(null, t, e), n)
      );
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = i),
        Au(Ba.bind(null, r, i, e), [e]),
        (r.flags |= 2048),
        qn(9, $a.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function Gu(e, t, n, r, l) {
  ...
  if ((en(t, l), t.stateNode === null))
    Fr(e, t), tc(t, n, r), Ui(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function Jd(e, t, n, r, l, i, o) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = ei(Error(k(422)))), Er(e, t, o, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (i = Error(k(419))), (r = ei(i, r, void 0)), Er(e, t, o, r);
  }
  if (((u = (o & e.childLanes) !== 0), de || u)) {
    ...
    return Qo(), (r = ei(Error(k(421)))), Er(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((Eo(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (xr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), ze !== null && (qi(ze), (ze = null)))),
        Hi(e, t),
        le(t),
        null
      );
    ...
    case 6:
      if (e && t.stateNode != null) dc(e, t, e.memoizedProps, r);
        ...
        if (((n = _t(Gn.current)), _t(Be.current), xr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ue] = t),
    ...
    case 13:
      if (
        ...
        if ($ && ge !== null && t.mode & 1 && !(t.flags & 128))
          ...
          le(t), (i = !1);
        } else ze !== null && (qi(ze), (ze = null)), (i = !0);
...
function tp(e, t) {
  ...
  for (Ti = { focusedElem: e, selectionRange: n }, Kr = !1, _ = t; _ !== null; )
...
function pc(e) {
  ...
  t !== null && ((e.alternate = null), pc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ue], delete t[Yn], delete t[zi], delete t[Dd], delete t[Ud])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
          ...
          for (_ = l; _ !== null; )
            (o = _),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((s.return = o), (_ = s))
                : rs(l);
        for (; i !== null; ) (_ = i), gc(i), (i = i.sibling);
        (_ = l), (_r = u), (ie = a);
      }
      ts(e);
    } else
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (_ = i)) : ts(e);
  }
}
function ts(e) {
  for (; _ !== null; ) {
...
function Me(e, t, n, r) {
  ...
  rr(e, n, r),
    (!(M & 2) || e !== b) &&
      (e === b && (!(M & 2) && (xl |= n), J === 4 && tt(e, te)),
      me(e, r),
      n === 1 && M === 0 && !(t.mode & 1) && ((an = K() + 500), yl && yt()));
}
function me(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && du(n), t === 1))
      e.tag === 0 ? $d(ls.bind(null, e)) : Na(ls.bind(null, e)),
        Id(function () {
          !(M & 6) && yt();
        }),
        (n = null);
...
function yc(e, t) {
  if (((Dr = -1), (Ur = 0), M & 6)) throw Error(k(327));
  var n = e.callbackNode;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Ri(xt.bind(null, e, fe, Ae), t);
            break;
          }
          xt(e, fe, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Ri(xt.bind(null, e, fe, Ae), r);
            break;
          }
          xt(e, fe, Ae);
          break;
...
function Vo(e, t) {
  ...
  try {
    ...
    (M = n), M === 0 && ((an = K() + 500), yl && yt());
  }
}
function zt(e) {
  rt !== null && rt.tag === 0 && !(M & 6) && tn();
  var t = M;
  M |= 1;
  var n = _e.transition,
    r = I;
...
function Qo() {
  (J === 0 || J === 3 || J === 2) && (J = 4),
    b === null || (!(Rt & 268435455) && !(xl & 268435455)) || tt(b, te);
}
function al(e, t) {
  var n = M;
  M |= 2;
  ...
  while (!0);
  if ((No(), (M = n), (ol.current = r), Y !== null)) throw Error(k(261));
...
function xt(e, t, n) {
  var r = I,
    l = _e.transition;
  try {
    (_e.transition = null), (I = 1), up(e, t, n, r);
  } finally {
    (_e.transition = l), (I = r);
  }
  return null;
...
function up(e, t, n, r) {
  ...
  if (ul) throw ((ul = !1), (e = Gi), (Gi = null), e);
  return (
    sl & 1 && e.tag !== 0 && tn(),
    (i = e.pendingLanes),
  ...
  if (rt !== null) {
    ...
    try {
      if (((_e.transition = null), (I = 16 > e ? 16 : e), rt === null))
        ...
        if (((e = rt), (rt = null), (sl = 0), M & 6)) throw Error(k(331));
        var l = M;
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = sn(Error(k(423)), t)), (t = Ju(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = sn(Error(k(424)), t)), (t = Ju(e, t, r, n, l));
            break e;
          } else
            for (
...
_l.prototype.render = Go.prototype.render = function (e) {
  var t = this._internalRoot;
  if (t === null) throw Error(k(409));
  El(e, t, null, null);
};
_l.prototype.unmount = Go.prototype.unmount = function () {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (mo(t, n | 1), me(t, K()), !(M & 6) && ((an = K() + 500), yt()));
      }
      break;
    case 13:
      zt(function () {
...
Ks = Vo;
Ys = zt;
var gp = { usingClientEntryPoint: !1, Events: [ir, Vt, gl, Hs, Qs, Vo] },
  Cn = {
  ...
  yp = {
    ...
    findFiberByHostInstance: Cn.findFiberByHostInstance || mp,
...
var wp = Ts.exports,
  ss = wp;
(oi.createRoot = ss.createRoot), (oi.hydrateRoot = ss.hydrateRoot);
/**
...
function Rc(e, t, n, r) {
  ...
  let l = (i, o, u) => {
    ...
    i.children &&
      ...
      Rc(i.children, t, h, a)),
      !(i.path == null && !i.index) &&
        t.push({ path: a, score: zp(a, i.index), routesMeta: h });
  };
  return (
    e.forEach((i, o) => {
      var u;
...
function zp(e, t) {
  ...
  return (
    ...
    n
      .filter((l) => !ds(l))
      .reduce((l, i) => l + (Pp.test(i) ? Np : i === "" ? Tp : Lp), r)
  );
}
function Op(e, t) {
  ...
  for (let u = 0; u < r.length; ++u) {
    ...
    Object.assign(l, p.params),
      o.push({
        ...
        pathnameBase: Ap(pt([i, p.pathnameBase])),
        route: m,
      }),
...
function Mc(e, t, n, r) {
  ...
  typeof e == "string"
    ...
    : ((l = er({}, e)),
      ...
      X(!l.search || !l.search.includes("#"), li("#", "search", "hash", l)));
  let i = e === "" || l.pathname === "",
    o = i ? "/" : l.pathname,
    u;
  if (o == null) u = n;
...
const qo = x.createContext(null),
  ...
  It = x.createContext(null),
  jl = x.createContext(null),
  Ft = x.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
  Fc = x.createContext(null);
function Yp(e, t) {
  let { relative: n } = t === void 0 ? {} : t;
  ur() || X(!1);
  let { basename: r, navigator: l } = x.useContext(It),
    { hash: i, pathname: o, search: u } = Uc(e, { relative: n }),
    s = o;
  return (
    r !== "/" && (s = o === "/" ? r : pt([r, o])),
...
function sr() {
  return ur() || X(!1), x.useContext(jl).location;
}
function Dc(e) {
...
function Gp() {
  ur() || X(!1);
  let e = x.useContext(qo),
    { basename: t, future: n, navigator: r } = x.useContext(It),
    { matches: l } = x.useContext(Ft),
    { pathname: i } = sr(),
    o = JSON.stringify(Oc(l, n.v7_relativeSplatPath)),
    u = x.useRef(!1);
  return (
    Dc(() => {
      u.current = !0;
...
function Uc(e, t) {
  let { relative: n } = t === void 0 ? {} : t,
    { future: r } = x.useContext(It),
    { matches: l } = x.useContext(Ft),
    { pathname: i } = sr(),
    o = JSON.stringify(Oc(l, r.v7_relativeSplatPath));
...
function Zp(e, t, n, r) {
  ur() || X(!1);
  let { navigator: l } = x.useContext(It),
...
function oh() {
  var e;
  let t = x.useContext(Fc),
    n = lh(),
    r = Ac();
  return t !== void 0 ? t : (e = n.errors) == null ? void 0 : e[r];
}
function uh() {
  let { router: e } = rh($c.UseNavigateStable),
    t = Ac(Bc.UseNavigateStable),
    n = x.useRef(!1);
  return (
    Dc(() => {
      n.current = !0;
  ...
  let {
    ...
    S = x.useMemo(() => {
      ...
      return E == null
        ? null
        : {
            location: { pathname: E, search: p, hash: m, state: y, key: w },
            navigationType: l,
          };
    }, [s, h, p, m, y, w, l]);
  return S == null
...
const wh =
  ...
  ii = x.forwardRef(function (t, n) {
    let {
      ...
      m = dh(t, mh),
      { basename: y } = x.useContext(It),
      w,
      S = !1;
    if (typeof a == "string" && Sh.test(a) && ((w = a), wh))
      try {
        let d = new URL(window.location.href),
          g = a.startsWith("//") ? new URL(d.protocol + a) : new URL(a),
          C = Zo(g.pathname, y);
        g.origin === d.origin && C != null
          ? (a = C + g.search + g.hash)
          : (S = !0);
      } catch {}
    let E = Yp(a, { relative: l }),
      f = kh(a, {
        replace: o,
        state: u,
        target: s,
    ...
    return x.createElement(
      "a",
      to({}, m, { href: w || E, onClick: S || i ? r : c, ref: n, target: s })
    );
  });
var ms;
(function (e) {
...
const xh = () => {
  ...
  Wc = () => {
    const [e, t] = x.useState("#f4f4f4"),
      [n, r] = x.useState(0),
      l = ["#f4f4f4", "#e8f5e8", "#fff2e8", "#f0e8ff", "#e8f4fd"],
      i = x.useCallback(() => {
        const s = (l.indexOf(e) + 1) % l.length;
        t(l[s]);
      }, [e, l]),
      o = x.useCallback(() => {
        r((u) => u + 1);
  ...
  Ch = () =>
    v.jsxs("nav", {
      className: "quick-nav",
      children: [
        v.jsx("a", { href: "#top", children: "Top" }),
        " |",
        v.jsx("a", { href: "#learn", children: "Learn" }),
        " |",
        v.jsx("a", { href: "#interactive", children: "Interactive" }),
        " |",
        v.jsx("a", { href: "#resources", children: "Resources" }),
        " |",
        v.jsx("a", { href: "#contact", children: "Contact" }),
      ],
    }),
  Eh = () =>
    v.jsxs("section", {
      ...
      className: "intro",
      children: [
        v.jsx("h2", { children: "What You'll Learn Here" }),
        v.jsxs("div", {
          className: "features",
          children: [
            v.jsxs("div", {
              className: "feature",
              children: [
                v.jsx("h3", { children: "HTML Structure" }),
                v.jsx("p", {
                  children:
                    "How web pages are built with HTML elements and tags.",
                }),
              ],
            }),
            v.jsxs("div", {
              className: "feature",
              children: [
                v.jsx("h3", { children: "CSS Styling" }),
                v.jsx("p", {
                  children:
                    "How to make websites look beautiful with colors, fonts, and layouts.",
                }),
              ],
            }),
            v.jsxs("div", {
              className: "feature",
              children: [
                v.jsx("h3", { children: "JavaScript Interactivity" }),
                v.jsx("p", {
                  children:
                    "How to add dynamic behavior and user interactions.",
                }),
              ],
            }),
          ],
  ...
  _h = () => {
    const { changeBackgroundColor: e, counter: t, incrementCounter: n } = Wc(),
      [r, l] = x.useState(""),
      [i, o] = x.useState(""),
      [u, s] = x.useState({ backgroundColor: "", color: "" }),
      a = () => {
        r.trim() === ""
          ? (o("Please enter a message first!"),
            s({ backgroundColor: "#ffe8e8", color: "#e74c3c" }))
          : (o(`Your message: "${r}"`),
            s({ backgroundColor: "#e8f6f3", color: "#27ae60" }),
            l(""));
      },
      h = (p) => {
        p.key === "Enter" && a();
    ...
    return v.jsxs("section", {
      ...
      children: [
        v.jsx("h2", { children: "Try Some Interactivity!" }),
        v.jsx("button", { onClick: e, children: "Change Background Color" }),
        v.jsxs("button", {
          onClick: n,
          children: ["Click Counter: ", v.jsx("span", { children: t })],
        }),
        v.jsxs("div", {
          className: "user-input",
          children: [
            v.jsx("h3", { children: "Leave a Message" }),
            v.jsx("input", {
              type: "text",
              value: r,
            ...
            v.jsx("button", { onClick: a, children: "Show Message" }),
            v.jsx("div", {
              style: u,
  ...
  Ph = () =>
    v.jsxs("section", {
      ...
      className: "resources",
      children: [
        v.jsx("h2", { children: "Learning Resources" }),
        v.jsx("p", {
          children:
            "Here are some great places to continue learning web development:",
        }),
        v.jsxs("ul", {
          children: [
            v.jsxs("li", {
              children: [
                v.jsx("strong", { children: "MDN Web Docs:" }),
                " Comprehensive documentation for HTML, CSS, and JavaScript",
              ],
            }),
            v.jsxs("li", {
              children: [
                v.jsx("strong", { children: "freeCodeCamp:" }),
                " Free interactive coding lessons",
              ],
            }),
            v.jsxs("li", {
              children: [
                v.jsx("strong", { children: "CSS-Tricks:" }),
                " Great tutorials and examples for CSS",
              ],
            }),
            v.jsxs("li", {
              children: [
                v.jsx("strong", { children: "JavaScript.info:" }),
                " In-depth JavaScript learning resource",
              ],
            }),
          ],
        }),
        v.jsx("p", {
          children:
            "Remember: the best way to learn is by building projects and experimenting with code!",
        }),
      ],
    }),
  Nh = () =>
    v.jsxs("section", {
      ...
      className: "contact",
      children: [
        v.jsx("h2", { children: "Get In Touch" }),
        v.jsx("p", {
          children:
            "This is a learning project, but feel free to explore the code!",
        }),
        v.jsxs("div", {
          ...
          children: [
            v.jsxs("p", {
              children: [
                v.jsx("strong", { children: "Tip:" }),
                " Open your browser's Developer Tools (F12) to see how this page works behind the scenes.",
              ],
            }),
            v.jsxs("p", {
              children: [
                v.jsx("strong", { children: "Challenge:" }),
                " Try modifying the CSS or JavaScript to customize this page.",
              ],
            }),
          ],
        }),
  ...
  jh = () => {
    ...
    return v.jsxs("div", {
      ...
      children: [
        v.jsxs("header", {
          children: [
            v.jsx("h1", { children: "Welcome to My First Web Application!" }),
            v.jsx("p", {
              children:
                "This is a simple two-page website to learn web development basics.",
            }),
          ],
        }),
        v.jsx(Ch, {}),
    ...
    const [e, t] = x.useState(""),
      n = () => {
        const r = new Date(),
          ...
          i = r.toLocaleDateString();
        t(`Current Date: ${i} | Current Time: ${l}`);
      };
    return v.jsxs(v.Fragment, {
      children: [
        v.jsxs("header", {
          children: [
            v.jsx("h1", { children: "About This Web Application" }),
            v.jsx("p", {
              children:
                "Learn how this simple website demonstrates key web development concepts.",
            }),
          ],
        }),
        v.jsxs("main", {
          children: [
            v.jsxs("section", {
              ...
              children: [
                v.jsx("h2", { children: "How This Website Works" }),
                v.jsxs("div", {
                  ...
                  children: [
                    v.jsxs("div", {
                      ...
                      children: [
                        ...
                        v.jsxs("p", {
                          children: [
                            "HTML provides the structure and content of web pages. It uses elements like ",
                            v.jsx("code", { children: "<h1>" }),
                            " for headings, ",
                            v.jsx("code", { children: "<p>" }),
                            " for paragraphs, and ",
                            v.jsx("code", { children: "<div>" }),
                            " for containers.",
                          ],
                        }),
                        v.jsxs("ul", {
                          children: [
                            ...
                            v.jsx("li", {
                              children:
                                "Links connect different pages together",
                            }),
                            v.jsx("li", {
                              children:
                    ...
                    v.jsxs("div", {
                      ...
                      children: [
                        v.jsx("h3", {
                          children: "CSS (Cascading Style Sheets)",
                        }),
                        v.jsx("p", {
                          children:
                            "CSS controls how the website looks - colors, fonts, spacing, and layout. It separates presentation from content.",
                        }),
                        v.jsxs("ul", {
                          children: [
                            v.jsx("li", {
                            ...
                            v.jsx("li", {
                              children: "Properties define visual styles",
                            }),
                            v.jsx("li", {
                              children:
                    ...
                    v.jsxs("div", {
                      className: "tech-item",
                      children: [
                        v.jsx("h3", { children: "JavaScript" }),
                        v.jsx("p", {
                          children:
                            "JavaScript adds interactivity and dynamic behavior. It can respond to user actions, modify content, and communicate with servers.",
                        }),
                        v.jsxs("ul", {
                          children: [
                            v.jsx("li", {
                              children:
                                "Event listeners respond to clicks, typing, etc.",
                            }),
                            v.jsx("li", {
                              children: "DOM manipulation changes page content",
                            }),
                            v.jsx("li", {
                              children: "Variables store and manage data",
                            }),
                          ],
                        }),
                      ],
            ...
            v.jsxs("section", {
              ...
              children: [
                v.jsx("h2", { children: "Interactive Demo" }),
                v.jsx("p", {
                  children:
                    "Click the button below to see JavaScript in action:",
                }),
                v.jsx("button", { onClick: n, children: "Show Current Time" }),
                e &&
                  v.jsx("div", {
                    style: {
                      marginTop: "1rem",
                ...
                v.jsxs("div", {
                  ...
                  children: [
                    v.jsx("h3", {
                      children: "Sample Code Behind This Button:",
                    }),
                    v.jsx("pre", {
                      children: v.jsx("code", {
                        children: `const showCurrentTime = () => {
  const now = new Date();
  ...
  Lh = () => {
    const [e, t] = x.useState(""),
      [n, r] = x.useState(""),
      [l, i] = x.useState(""),
      [o, u] = x.useState({ backgroundColor: "", color: "" }),
      s = () => {
        const h = parseFloat(e),
          p = parseFloat(n);
        if (isNaN(h) || isNaN(p))
          i("Please enter valid numbers in both fields!"),
            u({ backgroundColor: "#ffe8e8", color: "#e74c3c" });
        else {
          const m = h + p;
          i(`Result: ${h} + ${p} = ${m}`),
            u({ backgroundColor: "#e8f6f3", color: "#27ae60" });
        }
      },
      a = (h) => {
        h.key === "Enter" && s();
    ...
    return v.jsxs(v.Fragment, {
      children: [
        v.jsxs("header", {
          children: [
            v.jsx("h1", { children: "Addition Calculator" }),
            v.jsx("p", {
              children: "A simple calculator to add two numbers together.",
            }),
          ],
        }),
        v.jsx("main", {
          children: v.jsx("section", {
            ...
            children: v.jsxs("div", {
              ...
              children: [
                v.jsx("h2", { children: "Add Two Numbers" }),
                v.jsxs("div", {
                ...
                v.jsx("button", { onClick: s, children: "Calculate Sum" }),
                l &&
                  v.jsx("div", {
                    className: "result",
                    style: {
  ...
  Rh = () => {
    ...
    return v.jsxs("footer", {
      children: [
        v.jsx("p", {
          children: "© 2025 My First Web App. Built for learning!",
        }),
        v.jsx("button", {
          onClick: e,
  ...
  return v.jsx(yh, {
    children: v.jsxs("div", {
      ...
      children: [
        ...
        v.jsxs(fh, {
          children: [
            v.jsx(Br, { path: "/", element: v.jsx(jh, {}) }),
            v.jsx(Br, { path: "/about", element: v.jsx(Th, {}) }),
            v.jsx(Br, { path: "/addition", element: v.jsx(Lh, {}) }),
          ],
        }),
        v.jsx(Rh, {}),
      ],
...
oi.createRoot(document.getElementById("root")).render(
  v.jsx(Ns.StrictMode, { children: v.jsx(zh, {}) })
);
