...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (demoBtn && timeDisplay) {
        demoBtn.addEventListener('click', function() {
            ...
            timeDisplay.innerHTML = `
                <div style="margin-top: 1rem; padding: 1rem; background-color: #e8f6f3; border-radius: 5px;">
    ...
    console.log('🔧 Try modifying the JavaScript, CSS, or HTML to see how changes affect the website.');
});